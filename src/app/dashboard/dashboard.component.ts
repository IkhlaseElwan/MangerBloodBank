...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
      /* ----------==========     Daily Donastion Chart initialization For Documentation    ==========---------- */

      const dataDailySalesChart: any = {
          labels: ['M', 'T', 'W', 'T', 'F', 'S', 'S'],
          series: [
            // total number of donastion in day 
              [12, 30, 7, 17, 23, 18, 38]
          ]
      };
     ...
     const optionsDailySalesChart: any = {
      ...
      /* ----------==========    total Blood unit   initialization    ==========---------- */

      const dataCompletedTasksChart: any = {
          labels: ['12p', '3p', '6p', '9p', '12p', '3a', '6a', '9a'],
          series: [
              [230, 5, 450, 300, 280, 240, 200, 190]
          ]
      };
     ...
     const optionsCompletedTasksChart: any = {
      ...
      /* ----------==========    Donasion reason  initialization    ==========---------- */

      var datawebsiteViewsChart = {
        //labels: ['J', 'F', 'M', 'A', 'M', 'J', 'J', 'A', 'S', 'O', 'N', 'D'],
        labels: ['Family', 'Volnter', 'healthy'],
        series: [
          [542, 443, 320,]
